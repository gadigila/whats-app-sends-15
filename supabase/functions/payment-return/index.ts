...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('🔄 Payment return - Full URL:', req.url);
    console.log('🔄 Payment return - Extracted status:', status);
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .icon { width: 64px; height: 64px; margin: 0 auto 1rem; color: ${iconColor}; }
    h1 { font-size: 1.5rem; font-weight: bold; color: #111827; margin-bottom: 0.5rem; }
